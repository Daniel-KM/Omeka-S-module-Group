...
namespace DoctrineProxies\__CG__\Group\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Group extends \Group\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'comment', 'users', 'groupUsers', 'resources', 'groupResources'];
        }
    ...
    public function getGroupResources(): \Doctrine\Common\Collections\ArrayCollection
    {
        ...
        return parent::getGroupResources();
    }
